...
public class EventManagement extends EventServerPOA{
	...
	public EventManagement(String serverName){
		...
		filename  = "G:/workspace/COMP6231_Project/src/Replica03/" +this.serverName +"_Server.txt";
		...
		//getLogfilename = "C:/Java/EclipseWorkspace/COMP6231_Project/src/ReplicaManager03/" + this.serverName;
		getLogfilename = "G:/workspace/COMP6231_Project/src/ReplicaManager03/" + this.serverName;
	}
	//Display Databases...
	...
	public String UDPClient(String[] args) {
		...
		try {
			...
			for(i=0;i<2; i++) {
				...
				if (args[i].equals("QUE") ) {serverPort = 9006; requestdata[0] = args[i];}
				else if (args[i].equals("MTL")) {serverPort = 9007; requestdata[0] = args[i];}
				else if (args[i].equals("SHE")) {serverPort = 9008; requestdata[0] = args[i];}
