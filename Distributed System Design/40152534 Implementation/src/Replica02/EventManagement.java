...
public class EventManagement extends EventServerPOA{
	...
	public EventManagement(String serverName){
		...
		//For logging
		//filename  = "C:/Java/EclipseWorkspace/COMP6231_Project/src/Replica02/" +this.serverName +"_Server.txt";
		filename  = "G:/workspace/COMP6231_Project/src/Replica02/" +this.serverName +"_Server.txt";
		...
		//getLogfilename = "C:/Java/EclipseWorkspace/COMP6231_Project/src/ReplicaManager02/" + this.serverName;
		getLogfilename = "G:/workspace/COMP6231_Project/src/ReplicaManager02/" + this.serverName;
	}
	//Display Databases...
	...
	public String UDPClient(String[] args) {
		...
		try {
			...
			for(i=0;i<2; i++) {
				...
				if (args[i].equals("QUE") ) {serverPort = 9003; requestdata[0] = args[i];}
				else if (args[i].equals("MTL")) {serverPort = 9004; requestdata[0] = args[i];}
				else if (args[i].equals("SHE")) {serverPort = 9005; requestdata[0] = args[i];}
