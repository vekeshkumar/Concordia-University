...
public class ReplicaClient {
	static EventServer03 QUEImpl, MTLImpl, SHEImpl;
	...
	public static void setupORB(String[] args) {
		try {
			...
			String name = "QUE";			
			QUEImpl = EventServer03Helper.narrow(ncRef.resolve_str(name));
			System.out.println("Obtained a handle on QUE Server object: "+QUEImpl);

			//Resolve the object reference in naming
			name = "MTL";			
			MTLImpl = EventServer03Helper.narrow(ncRef.resolve_str(name));
			System.out.println("Obtained a handle on MTL Server object: "+MTLImpl);
			
			//Resolve the object reference in naming
			name = "SHE";			
			SHEImpl = EventServer03Helper.narrow(ncRef.resolve_str(name));
	...
	//Call Replica..
	public static String callReplica(String[] args, EventServer03 obj) {
