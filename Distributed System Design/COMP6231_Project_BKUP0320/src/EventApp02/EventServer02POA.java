...
/**
* EventApp02/EventServer02POA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from C:/Java/EclipseWorkspace/COMP6231_Project/Event03.idl
* Thursday, March 19, 2020 10:27:37 AM EDT
*/

public abstract class EventServer02POA extends org.omg.PortableServer.Servant
 implements EventApp02.EventServer02Operations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // EventApp02/EventServer02/addEvent
       {
       ...
       case 1:  // EventApp02/EventServer02/removeEvent
       {
         String eventID = in.read_string ();
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 2:  // EventApp02/EventServer02/listEventAvailability
       {
         String eventType = in.read_string ();
         String $result = null;
       ...
       case 3:  // EventApp02/EventServer02/bookEvent
       {
       ...
       case 4:  // EventApp02/EventServer02/getBookingSchedule
       {
         String customerID = in.read_string ();
         String $result = null;
       ...
       case 5:  // EventApp02/EventServer02/cancelEvent
       {
         String customerID = in.read_string ();
         String eventID = in.read_string ();
         String eventType = in.read_string ();
       ...
       case 6:  // EventApp02/EventServer02/swapEvent
       {
         String customerID = in.read_string ();
       ...
       case 7:  // EventApp02/EventServer02/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:EventApp02/EventServer02:1.0"};
  ...
  public EventServer02 _this() 
  {
    return EventServer02Helper.narrow(
    super._this_object());
  }

  public EventServer02 _this(org.omg.CORBA.ORB orb) 
  {
    return EventServer02Helper.narrow(
