...
public class ClientImplementation {
	...
	//Get the port registered from the registry
		static {
			try {
				registryMTL = LocateRegistry.getRegistry("localhost", Constants.RMI_PORT_NO_MTL);
				registryQUE = LocateRegistry.getRegistry("localhost", Constants.RMI_PORT_NO_QUE);
				registrySHE = LocateRegistry.getRegistry("localhost", Constants.RMI_PORT_NO_SHE);
	...
	public String swapEvent(String clientId, String eventId, String eventType, String oldEventId, String oldEventType) {
