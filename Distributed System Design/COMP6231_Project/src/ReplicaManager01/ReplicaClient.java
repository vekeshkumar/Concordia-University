...
import EventApp01.EventServer01;
import EventApp01.EventServer01Helper;

public class ReplicaClient {
	static EventServer01 QUEImpl, MTLImpl, SHEImpl;
	...
	public static void setupORB(String[] args) {
		try {
			...
			String name = "QUE";			
			QUEImpl = EventServer01Helper.narrow(ncRef.resolve_str(name));
			...
			//Resolve the object reference in naming
			name = "SHE";			
			SHEImpl = EventServer01Helper.narrow(ncRef.resolve_str(name));
	...
	//Call Replica..
	public static String callReplica(String[] args, EventServer01 obj) {
