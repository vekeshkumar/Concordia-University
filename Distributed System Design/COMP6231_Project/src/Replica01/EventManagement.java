...
public class EventManagement extends EventServer01POA{
	...
	public synchronized void logging(String infoMsg) {
		...
		//Write eventDB
		File file = new File("C:/Java/EclipseWorkspace/COMP6231_Project/src/ReplicaManager01/" + this.serverName +"_eventDB.txt"); 
		...
		//Write Customer DB
		file = new File("C:/Java/EclipseWorkspace/COMP6231_Project/src/ReplicaManager01/" + this.serverName +"_custDB.txt"); 
