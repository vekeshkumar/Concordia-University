...
import com.web.server.UDPIntReqClient;
import com.web.server.UDPServer;
...
public class ServerImplementation implements WebInterface {
	...
	public HashMap<String,HashMap<String, List<Event>>> eventRecordMTL;
	public HashMap<String,HashMap<String, List<Event>>> eventRecordQUE;
	public HashMap<String,HashMap<String, List<Event>>> eventRecordSHE;
	...
	public ServerImplementation(ServerCenterLocation scloc)
		...
		setIPAddress(scloc);
		System.out.println(scloc);
		
	}
	public void setIPAddress(ServerCenterLocation scloc) {
		switch (scloc) {
		case MTL:
			IPAddress = Constants.WS_SERV_ADDR_MTL;			
			break;
		case QUE:
			IPAddress = Constants.WS_SERV_ADDR_QUE;
			break;
		case SHE:
			IPAddress = Constants.WS_SERV_ADDR_SHE;
			break;
		default:
			break;
		}
